...
const animationTrigger = document.createElement('div');
animationTrigger.classList.add('animation-trigger');
animationTrigger.style.height = "700vh";
document.body.appendChild(animationTrigger);